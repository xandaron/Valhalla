...
// 				if updateScene(graphicsContext) != nil {
...
// 	constructMenuBar :: proc(graphicsContext: ^GraphicsContext) {
// 		scene := &globals.scene
...
// 						if !alreadyLoaded {
// 							addModels(graphicsContext, &scene.graphicsData, {file})
...
// 	constructShaderEditor :: proc(graphicsContext: ^GraphicsContext) {
// 		if imgui.Button("Reload Shaders") {
// 			if reloadShaders(graphicsContext) != nil {
// 				panic(fmt.tprintf("Failed to reload shaders!"))
// 			}
// 			if updateCommandBuffers(graphicsContext) != nil {
// 				panic(fmt.tprintf("Failed to reload shaders!"))
// 			}
// 		}
// 	}

// 	constructCamerasHeader :: proc(graphicsContext: ^GraphicsContext) {
// 		scene := &globals.scene
...
// 	constructLightsHeader :: proc(graphicsContext: ^GraphicsContext) {
// 		scene := &globals.scene
...
// 	constructObjectsHeader :: proc(graphicsContext: ^GraphicsContext) {
// 		scene := &globals.scene
...
// 			if imgui.Button("Delete") {
// 				removeInstance(&scene.graphicsData, object.graphicsData)
...
// 	constructModelsHeader :: proc(graphicsContext: ^GraphicsContext) {
// 		scene := &globals.scene
...
mouseButtonCallback :: proc "c" (window: glfw.WindowHandle, button, action, mods: i32) {
	...
	// 		logf(.Debug, "Selected instance: {}", object.name)
